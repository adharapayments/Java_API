 ...
 * @author gudu
 */
public class SendLimitTradeExample {
    public static void main(String[] args) throws InterruptedException 
    {
        ...
        try
        {
            ...
            System.out.println("Price: " + pricesFB.getPrices_ask(0));
            System.out.println("Trading Interface ID: " + tiID);
            System.out.println("Security: EUR/USD");
            System.out.println();
            
            System.out.println("mapREST.sendTrade");
            trade = mapREST.sendLimitTrade (StubConstants.TRADE_SIDE_BUY, StubConstants.TRADE_TIMEINFORCE_INMED_OR_CANCEL, 
                                            pricesFB.getPrices_ask(0), 100000, tiID, StubConstants.mapSecurities.get("EUR_USD"), 
                                            user, password);
